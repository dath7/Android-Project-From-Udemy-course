       ...
       implements YouTubePlayer.OnInitializedListener
{
    ...
    public static final String GOOGLE_API_KEY = "AIzaSyAcQsEES4N8SAC0OM0pxfxEp9AhWzYIODk";
    public static final String YOUTUBE_VIDEO_ID = "CD1Hncy4nIA";
    ...
    public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
        ...
        if (youTubeInitializationResult.isUserRecoverableError()) {
            ...
            String errorMessage = String.format("There was an error initializing the YoutubePlayer (%1s)",youTubeInitializationResult.toString());
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onAdStarted() {
            Toast.makeText(YoutubeActivity.this,"Ads started",Toast.LENGTH_LONG).show();
        }
